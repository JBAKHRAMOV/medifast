...
import com.company.bot.dto.PdfDTO;
...
public class GeneratePdfService {
    ...
    public void createPdf(PdfDTO dto) {
        ...
        try {
            ...
            if (dto.getUser().getDiabets() != null)
                p2.add("\nQandli diabet: " + dto.getUser().getDiabets());
            if (dto.getUser().getBloodPrassure() != null)
                p2.add("\nQon bosimi: " + dto.getUser().getBloodPrassure());
            if (dto.getUser().getTemprature() != null)
                p2.add("\nTempratura: " + dto.getUser().getTemprature());
            if (dto.getUser().getHeartBeat() != null)
                p2.add("\nYurak urishi: " + dto.getUser().getHeartBeat());
